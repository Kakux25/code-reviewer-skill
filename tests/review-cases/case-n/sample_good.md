...
**Verdicts**: architectural `Low` (documented side-effect-free property violated); soul `Betrayed` — "Honest API: names say what they do ... never mutates its input" (base/PHILOSOPHY.md) is contradicted by the in-place sort.
